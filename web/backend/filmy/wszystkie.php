    ...
    <div class="col-md-12">
        <div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
            ...
            <div class="carousel-inner">
                ...
                <div class="item">
                    <img class="slide-image" src="http://lorempixel.com/800/300/?adas=23s" alt="">
                </div>
                <div class="item">
                    <img class="slide-image" src="http://lorempixel.com/800/300/?adas=231" alt="">
                </div>
            </div>
...
<div class="row">
    ...
    <div class="col-sm-4 col-lg-4 col-md-4">
        <div class="thumbnail">
            <div class="ratio" style="background-image:url('http://lorempixel.com/800/300/')"></div>
